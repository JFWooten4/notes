...
Else:
1. Position on Securency operating validators.
2. Then minor oral points:
    1. Cross-chain.
    2. How custody pools work with that.

## Messages to Chives

1. Started wanting to take down DTC.
2. Sees role as unifying layer.
3. Has dev _this year_ for token entitlements settling at T+1.

Told SpiceVC about idea in UAE 2015.

1. Carlos rebrands and enters market that year within 3 months.
2. Entitlements as tokens stay in Cede.
3. The promises are margin in NSCC.
